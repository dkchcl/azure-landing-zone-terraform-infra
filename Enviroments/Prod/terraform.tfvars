...
#   "db1" = {
#     db_name             = "proddb-01"
#     sql_server_name     = "prodnewsqlserver909"
#     resource_group_name = "prod_rg_01"
#     sku_name            = "GP_Gen5_2"
#     max_size_gb         = 5
...
virtual_machine_scale_sets = {
  ...
  frontend = {
    ...
    subnet_name          = "subnet-01"
    nsg_name             = "prodnsg01"
    # app_gateway_name                = "prod-appgw-frontend"
    instances                       = 1
    upgrade_mode                    = "Manual"
    disable_password_authentication = false
...
vmss_autoscale_settings = {
  ...
  vmss_backend_autoscale = {
    name                = "prod-vmss-02-autoscale"
    resource_group_name = "prod_rg_01"
    location            = "West US 2"
    vmss_name           = "prod-vmss-02"
  ...
  vmss_frontend_autoscale = {
    name                = "prod-vmss-01-autoscale"
    resource_group_name = "prod_rg_01"
    location            = "West US 2"
    vmss_name           = "prod-vmss-01"
